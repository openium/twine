...
module Twine
  module Formatters
    class AppleObjC < Abstract
      FORMAT_NAME = 'apple-objc'
      EXTENSION = '.hm'
      DEFAULT_FILE_NAME = 'R2String+TxtFileName.hm'
      ...
      def write_file(path, lang)
        ...
        header = "R2String+" + stringFileName + ".h"
        headerPath = filePath.dirname + header
        impl = "R2String+" + stringFileName + ".m"
...
Twine::Formatters.formatters << Twine::Formatters::AppleObjC.new
